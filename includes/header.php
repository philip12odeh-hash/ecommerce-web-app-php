...
<!--- header --->
 ...
 <div class="topnav" >
  ...
  <a href = "#latest" id="NewArrivals">New Arrivals </a>
  <a href = "trousers.php" id="trousers">Trousers</a>
  <a href = "Shirts.php" id="Shirts">Shirts</a>
  <a href = "Shots.php" id="Shots">Shorts</a>
  <a href = "Jersy.php" id="Jersy">jersy's</a>
  <a href = "Sweater.php" id="Sweater">Sweater's</a>
  <a href = "Shoes.php" id="Shoes">Shoes</a>
  <a href = "perfumes.php" id="Perfumes">Perfumes</a>
  <?php if(isset($_SESSION["userid"])){
	  echo'<a href = "includes/logout.php" title = "LogOut" id="login_icon"><i class="fa fa-sign-out" aria-hidden="true"></i></a>'; } else{
	  echo '<a href = "register.php" title = "LogIn" id="login_icon"><i class="fa fa-sign-in" aria-hidden="true"></i></a>';
  }?>
  ...
  <a href = "check_out.php" id = "cart" ><i class="fa fa-shopping-cart"></i><sup id="cart_count"><?php echo $totalItems ?></sup></a>
...
<div id="advertisement">
	<div class="advert"><?php if(isset($_SESSION["userid"])){echo '<a href="admin/admin_home.php">click here to perform admin tasks </a>'; }?></div>
	<div class="advert">Make Notice, promo's and News Scrole here</div>
