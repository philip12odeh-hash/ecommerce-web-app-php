...
<div class="container-fluid">
	...
	<?php
			...
			if ($_POST['Cart']=== 'Add to Cart') {
				...
				echo "<br>". $item_brand = $_POST["MATERIAL"];
				echo "<br>". $item_material = $_POST["ITEM_NO"];
		...
		// 1. Check if the item is already there
				...
				if ($itemExists > 0) {
					...
					$stmt = $conn->prepare("INSERT INTO cart 
						(Item_Image, Item_Price, Quantity, ITEM_NO)
						VALUES (:Item_Image, :Item_Price, :Quantity, :ITEM_NO)");
